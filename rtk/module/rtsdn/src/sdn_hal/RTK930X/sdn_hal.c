...
#endif
#endif  //#ifdef  CONFIG_SDK_RTL9300
                                     ...
                                     rtk_of_flowCntMode_t mode)
{
    ...
    */
    ...
    if(( ret = rtk_of_flowCntMode_set(unit, (rtk_of_flowtable_phase_t) table_id, (rtk_of_flow_id_t) flow_id, mode)) != RT_ERR_OK)
    {
        printf("[%s][%d] fail to get flow count mode, ret=[%d]. \n", __FUNCTION__, __LINE__, ret);
        return ret;
    }
...
#endif
#endif  //#ifdef  CONFIG_SDK_RTL9310
